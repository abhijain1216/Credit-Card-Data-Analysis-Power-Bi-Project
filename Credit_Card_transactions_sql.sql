...
--- Add data for week - 53
COPY Credit_Card_detail
FROM 'D:\Projects\Power Bi Projects\Credit Card Transactions Power bi Project\cc_add.csv'
DELIMITER ','
CSV HEADER;

COPY Customer_detail
FROM 'D:\Projects\Power Bi Projects\Credit Card Transactions Power bi Project\cust_add.csv'
DELIMITER ','
CSV HEADER;
